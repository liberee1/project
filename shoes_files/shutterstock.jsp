	...
	usi_analytics = {
		...
		usi_app.load = function () {
			...
			try {
				...
				} else if ((usi_app.is_english || usi_app.is_german_language) && !usi_app.is_existing_customer && usi_date.is_between('2022-07-31T21:01:00', '2022-08-05T20:59:00')) {
					// Sitewide events
					var language_key = usi_app.get_language_key();
					usi_commons.log('[ load ] * * * Load Sitewide Events TT [August | language ' + usi_commons.device + language_key + '] * * *');
					usi_commons.load_view("mMA1IChU6OSRGSHGoiU2gU1", "35747", usi_commons.device + language_key);
				} else if (!usi_app.is_existing_customer && (usi_app.is_video_page || usi_app.is_footage_in_cart) && !usi_date.is_between('2022-07-31T21:01:00', '2022-08-05T20:59:00')) {
					var language_key = usi_app.get_language_key();
				...
				if (typeof (usi_app.interval_id) === "undefined") {
					usi_app.interval_id = setInterval(function () {
						if ( ((usi_app.is_image() && location.href.indexOf("/purchase") != -1) || usi_app.is_image_page) && !usi_app.is_checkout_page
							&& (!usi_app.is_footage_in_cart && !usi_date.is_between('2022-07-31T21:01:00', '2022-08-05T20:59:00') )) {
